...
// TESTING RATIONALE
//
// This set of test cases are related to the euclidean_vector negation operator.
//
...
TEST_CASE("Negation should return negative copy") {
	...
	SECTION("1 dimension euclidean vector") {
		auto euc_vec1 = comp6771::euclidean_vector({1.0});
		auto euc_vec2 = -euc_vec1;
		CHECK(euc_vec2.at(0) == Approx(-1.0));
	}

	SECTION("2 dimension euclidean vector") {
		auto euc_vec1 = comp6771::euclidean_vector({-42.0, 21.3});
		auto euc_vec2 = -euc_vec1;
	...
	SECTION("3 dimension euclidean vector") {
		auto euc_vec1 = comp6771::euclidean_vector({-2.032, 8.3293, 12.429});
		auto euc_vec2 = -euc_vec1;
